...
CFLAGS = -fno-pic -static -fno-builtin -fno-strict-aliasing -Wall -MD -ggdb -m32 -Werror -fno-omit-frame-pointer -D $(SELECTION)=1 -D $(VERBOSE_PRINT)=1
...
EXTRA=\
	mkfs.c ulib.c user.h cat.c myMemTest.c echo.c forktest.c grep.c kill.c\
